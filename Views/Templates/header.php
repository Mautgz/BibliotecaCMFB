...
<body class="app sidebar-mini">
    <!-- Navbar-->
    <header class="app-header"><a class="app-header__logo" href="<?php echo base_url; ?>Configuracion/admin">CMFB Biblioteca</a>
    ...
    <aside class="app-sidebar">
        ...
        <ul class="app-menu">
            ...
            <!-- Libros como enlace directo, no desplegable -->
            ...
            <li class="treeview"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-file-text"></i><span class="app-menu__label">Reportes</span><i class="treeview-indicator fa fa-angle-right"></i></a>
                <ul class="treeview-menu">
                    ...
                    <li><a class="treeview-item" target="_blank" href="<?php echo base_url; ?>Libros/inventario"><i class="icon fa fa-file-pdf-o"></i> Inventario de Libros</a></li>
                    <li><a class="treeview-item" target="_blank" href="<?php echo base_url; ?>Alumnos/listado"><i class="icon fa fa-file-pdf-o"></i> Listado de Alumnos</a></li>
                </ul>
            </li>
        </ul>
    </aside>
